...
public class LessonProgramService {
    ...
    public Set<LessonProgram> getLessonProgramById(Set<Long> lessonIdSet) {
        Set<LessonProgram> lessonPrograms = lessonProgramRepository.getLessonProgramNyLessonProgramIdList(lessonIdSet);
    ...
    public ResponseMessage<LessonProgramResponse> saveLessonProgram(LessonProgramRequest lessonProgramRequest) {
        ...
        // !!! yukarda gelen lessons ici bos mu control
        if (lessons.isEmpty()) {
    ...
    public List<LessonProgramResponse> getAllLessonProgramUnassigned() {
        // TODO: Student ekleme yapilmismi control
    ...
    // TODO: Student eklenmisw olabilir, control edilmeli
