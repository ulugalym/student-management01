...
public class StudentInfoService {
    ...
    public ResponseMessage<StudentInfoResponse> saveStudentInfo(HttpServletRequest httpServletRequest,
        ...
        // !!! ayni ders icin duplicate control
    ...
    public Page<StudentInfoResponse> getAllForSetudent(HttpServletRequest httpServletRequest, int page, int size) {
    ...
    public List<StudentInfoResponse> getStudentInfoByStudentId(Long studentId) {
        ...
        if(student.getUserRole().getRoleType()!=RoleType.STUDENT){
            throw new ResourceNotFoundException(String.format(ErrorMessages.NOT_FOUND_STUDENTS_MESSAGE,studentId));
        }
        if(!studentInfoRepository.existsByStudent_IdEquals(studentId)){
            throw new ResourceNotFoundException(String.format(ErrorMessages.STUDENT_NOT_FOUND_BY_STUDENT_ID,studentId));
        }
